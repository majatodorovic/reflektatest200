  ...
  return (
      <>
       {indexBanner1[0]?.image ? (
        ...
        <div className="col-span-2 max-lg:col-span-5">
          <div className="grid grid-cols-5 gap-x-20 xl:gap-x-10">
            <div className="col-span-2 max-lg:place-self-center place-self-center max-sm:col-span-5">
              <h1 className="font-medium text-[2rem] mt-[2rem] max-md:text-xl text-black">
                {action1[0]?.title}
              </h1>
        ...
        <div className="col-span-2 h-full max-lg:w-[100%] w-full max-lg:col-span-5 max-xl:mt-5 flex items-center">
          <div className="w-full min-h-[190px]  relative rounded-lg overflow-hidden">
            <Image
