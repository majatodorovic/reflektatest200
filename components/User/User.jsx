    ...
    <>
      ...
      <div className="mx-auto">
        <div className="mx-auto grid grid-cols-6 gap-y-3 gap-x-3 sm:mt-8 ">
          <div className="col-span-6 p-1 sm:col-span-3 px-8 bg-croonus-gray rounded-lg py-[9rem] md:ml-[2rem] max-md:mx-[1rem] max-md:mt-[1rem] mb-[2rem]">
          ...
          <div className="col-span-6 p-1 sm:col-span-3 px-8 bg-croonus-gray rounded-lg py-[9rem] md:mr-[2rem] max-md:mx-[1rem] max-md:mt-[1rem] mb-[2rem]">
            <Registration />
          </div>
        </div>
      </div>
